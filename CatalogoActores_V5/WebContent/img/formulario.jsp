                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-12 mb-3">
                                    ...
                                    <select class="w-100" id="country">
                                        ...
                                        <option value="ind">Reino Unido</option>
                                ...
                                <div class="col-12 mb-3">
                                    <label for="numero">Número teléfono <span>*</span></label>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="password" class="form-control" id="postcode" value="" name="contrasena">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="repContraseña">Repite Contraseña <span>*</span></label>
                                    <input type="password" class="form-control" id="postcode" value="">
								</div>
                                <div class="col-12">
                                    ...
                                    <!-- <div class="custom-control custom-checkbox d-block mb-2">
                                        ...
                                        <label class="custom-control-label" for="customCheck2">Crear la cuenta</label>
                                    </div>-->
